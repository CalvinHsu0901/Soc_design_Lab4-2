# 0 "counter_la_fir.c"
# 1 "/home/ubuntu/Desktop/lab4/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_fir.c"
# 19 "counter_la_fir.c"
...
# 78 "counter_la_fir.c"
 ...
 (*(volatile uint32_t*)0x30000020) = 0;
 (*(volatile uint32_t*)0x30000024) = -10;
 (*(volatile uint32_t*)0x30000028) = -9;
 (*(volatile uint32_t*)0x3000002c) = 23;
 (*(volatile uint32_t*)0x30000030) = 56;
 (*(volatile uint32_t*)0x30000034) = 63;
 (*(volatile uint32_t*)0x30000038) = 56;
 (*(volatile uint32_t*)0x3000003c) = 23;
 (*(volatile uint32_t*)0x30000040) = -9;
 (*(volatile uint32_t*)0x30000044) = -10;
 (*(volatile uint32_t*)0x30000048) = 0;
# 157 "counter_la_fir.c"
 for(int i=0; i<3; i++){
